...
export default function FrameInspector({ stage, onStageChange, onExit, draft, onDraftChange, mac, onApply }: Props) {
  ...
  return <main className="inspector" aria-label="Frame inspector">
    ...
    {unavailable ? <section className="inspector__unavailable" aria-live="polite"><h2>{stage.replace(/-/g, " ")}</h2><p>Calculation not available yet. This stage depends on a PHY profile that is verification-blocked, so no simulated values are displayed.</p></section> : <>

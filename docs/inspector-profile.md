...
| `ieee-8023-2022-line-check` | [Blocked final line-check register](inspector-ieee-line-check.md), source-manifest skeleton `test/fixtures/inspector/ieee-8023-2022-source-manifest.json` | One blocked record exists for each required final clause. No clause text, table row, exact state, source hash, or interpreted fixture hash is admitted. |

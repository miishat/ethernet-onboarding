...
| `ieee-8023-2022-local-line-check` | [Partially admitted local line-check register](inspector-ieee-line-check.md); Clause 117, 119, 120, and 124 extracts in `knowledge_base_ieee` | User-provided local copies reviewed 2026-09-23. Clause 49, Clause 82, and Annex 119A remain unavailable; no Annex source or fixture hash is admitted. |
...
| --- | --- | --- |
| `rs-cdmii-placement` | **Blocked.** Clause 117 locally confirms 64-bit paths, lane ordering, Start lane 0, and Terminate range, but defers the full stream. | Clause 82 control mapping and a CDMII fixture. |
...
| `codeword-interleave` | **Verified.** Final 119.2.4.7, p. 4850, local Clause 119 PDF. | Codeword-orientation adapter and pair-to-16-lane fixture. |
| `annex-119a-fixture` | **Blocked.** Annex 119A is absent from the local evidence set. | Obtain a final local copy, record table source/hash/state/encoding, independently regenerate and admit a separate fixture. |
...
The remaining final IEEE line check must cover Clauses 49 and 82 plus Annex 119A. The locally admitted Clause 117, 119.2.4.1 through 119.2.4.7, 120.5.2, and 124 records identify their exact local PDF, printed page, access path, and retrieval date. No third-party mirrored copyrighted text is accepted as final-profile authority.

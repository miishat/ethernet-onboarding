...
This primitive does not accept Ethernet bits or claim a `400gbase-dr4-tx-v1` result. Pre-FEC distribution, codeword interleave, PCS lanes, PMA mapping, and PAM4 stay blocked pending their own final sources and vectors.
